...
def executa_mdlo_cncl_lgdo_prjt(params: list) -> None:
    """
    Função wrapper para executar a base tbciar_re_mdlo_cncl_lgdo_prjt
    ...
    du.write_by_name(df, "CURVA_LEG_CANC", "internal", partitions=["cd_dia_crte", "dh_crga"], mode="overwrite")
    df.unpersist()
...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .appName("SPARK_prod_prazo_tbciar_re_mdlo_cncl_lgdo_prjt")
        .enableHiveSupport()
        .getOrCreate()
    )
    ...
    executa_mdlo_cncl_lgdo_prjt(sys.argv[1:])
